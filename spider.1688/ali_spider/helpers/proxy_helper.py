...
from ali_spider.db.mongo import ProxyItemsAliDB
...
class ProxyHelper(object):
    ...
    @staticmethod
    def get_proxy_items_jd_type_http():
        try:
            proxy_items = ProxyItemsAliDB.get_proxy_items()
    ...
    @staticmethod
    def get_proxy_items_jd_type_https():
        try:
            proxy_items = ProxyItemsAliDB.get_proxy_items()
