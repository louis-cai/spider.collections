...
#### 变量
log_file = "log/check_proxy_to_qianlima.log"
test_url = "http://www.qianlima.com/"
test_txt = "qianlima"
test_to_collection = "proxy_items_qianlima"
test_to_collection_2 = "proxy_items_qianlima_2"
test_timeout = 1
...
if __name__ == "__main__":
    ...
    cur = proxy_db.proxy_items_all.find({}, {'_id': 0}).batch_size(50).skip(18748)
    i = 0
    for item in cur:
        logging.info("i+++++++++++++++++++:%s" % i)
        i += 1
