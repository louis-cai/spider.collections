...
class RedisClient(object):
    ...
    def set_company_name_key(company_name):
        redis_client.hset("zhaopin.company_name", company_name, True)

    @staticmethod
    def get_company_name_key(company_name):
        return redis_client.hexists("zhaopin.company_name", company_name)

    @staticmethod
    def set_company_url_key(url):
        redis_client.hset("zhaopin.company_url", url, True)

    @staticmethod
    def get_company_url_key(url):
        return redis_client.hexists("zhaopin.company_url", url)

    @staticmethod
    def set_search_url_key(url):
        redis_client.hset("zhaopin.search_url", url, True)

    @staticmethod
    def get_search_url_key(url):
        return redis_client.hexists("zhaopin.search_url", url)
