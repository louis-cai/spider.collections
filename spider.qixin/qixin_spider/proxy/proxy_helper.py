...
from qixin_spider.db.mongo import ProxyItemsQixinDB
...
class ProxyHelper(object):
    ...
    @staticmethod
    def get_proxy_items_qixin_type_http():
        try:
            proxy_items = ProxyItemsQixinDB.get_proxy_items()
    ...
    @staticmethod
    def get_proxy_items_qixin_type_https():
        try:
            proxy_items = ProxyItemsQixinDB.get_proxy_items()
