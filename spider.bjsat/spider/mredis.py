...
class RedisClient(object):
    ...
    @staticmethod
    def get_result_url_key(url):
        return redis_client.hexists("bjsat.result_url", url)

    @staticmethod
    def set_result_url_key(url):
        redis_client.hset("bjsat.result_url", url, True)

    @staticmethod
    def get_search_key(search_key):
        return redis_client.hexists("bjsat.search_key", search_key)

    @staticmethod
    def set_search_key(search_key):
        redis_client.hset("bjsat.search_key", search_key, True)
