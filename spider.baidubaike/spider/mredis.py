...
class RedisClient(object):
    ...
    def set_search_key(search_key):
        redis_client.hset("baidubaike.search_key", search_key, True)
        # pass

    @staticmethod
    def get_search_key(search_key):
        return redis_client.hexists("baidubaike.search_key", search_key)
        # return False

    @staticmethod
    def set_url(url):
        redis_client.hset("baidubaike.url", url, True)
        # pass

    @staticmethod
    def get_url(url):
        return redis_client.hexists("baidubaike.url", url)
        # return False
